...
module.exports = {
  ...
  schema: [
    ...
    { name: 'maxPages', label: 'Max pages per query', type: 'number', default: 3,
      hint: 'Bitmagnet is local, so over-fetching costs almost nothing and protects against a noisy query burying real hits.' },
    { name: 'queryConcurrency', label: 'Concurrent queries', type: 'number', default: 4 },
